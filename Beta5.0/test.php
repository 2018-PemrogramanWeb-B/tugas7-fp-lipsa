    ...
    <div data-spy="scroll" data-target=".nav-pills" class="tab-content" id="v-pills-tabContent">
      ...
      <div class="tab-pane fade jumbotron" id="s21" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-21-answers" id="question-21-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s22" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-22-answers" id="question-22-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s23" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    <div class="quiz-overlay"></div>
                    <h3 class="pb-2 mt-4 mb-2 border-bottom">Kamu diperintah dosen menilai tugas kelas karena kamu seorang ketua kelas, dimana kamu akan menilai tugasnya?</h3>
                    <div class="mtm">
                        <input type="radio" name="question-23-answers" id="question-23-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s24" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-24-answers" id="question-24-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s25" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-25-answers" id="question-25-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s26" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-26-answers" id="question-26-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s27" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-27-answers" id="question-27-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s28" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-28-answers" id="question-28-answers-A" value="A" required />
      ...
      <div class="tab-pane fade jumbotron" id="s29" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-29-answers" id="question-29-answers-A" value="A" required />
                        <label for="question-5-answers-A" class="fwrd labela">Biasa saja</label>
                    </div>
                    <div>
      ...
      <div class="tab-pane fade jumbotron" id="s30" role="tabpanel">
        <ul class="list-unstyled">
            <li>
                    ...
                    <div class="mtm">
                        <input type="radio" name="question-30-answers" id="question-30-answers-A" value="A" required />
        ...
        <input class="btn btn-primary" type="submit" value="Submit Quiz" id="submit-quiz" data-dismiss="modal" disabled />
        </form>
    </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript">
            $(document).on("change", "#quiz", function() {
              $("#submit-quiz").prop("disabled", !this.checkValidity())
            });
